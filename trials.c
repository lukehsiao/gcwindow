...
{
  int i;
	char imgtextpath[1024], path[1024], imgsacpath[1024], imgsacblurpath[1024], savetextpath[1024];;
    ...
    {            /* #1: gaze-contingent text, normal in window, "xx" outside */
      case 1:
		...
		*/  
		...
		bitmap_save_and_backdrop(fgbm, 0, 0, 0, 0,"text.png", path, SV_NOREPLACE,
...
//		eyemsg_printf("!V IMGLOAD FILL images/sacrmeto.jpg");	
      ...
      case 5:    /* #5: Image, blurred outside window */
		...
		//eyemsg_printf("!V IMGLOAD FILL images/sacrmeto.jpg");   //should be eyemsg_printf("!V IMGLOAD FILL images/sac_blur.jpg");

...
int main(int argc, char **argv) {
    ...
    main_window = SDL_SetVideoMode(
        1280, 1024, 32, FLAGS | SDL_FULLSCREEN | SDL_DOUBLEBUF);
    source = SDL_CreateRGBSurface(
        FLAGS, main_window->w, main_window->h, 32, 0, 0, 0, 0);
    ...
    SDL_FillRect(
        main_window, NULL, SDL_MapRGB(main_window->format, bg.r, bg.g, bg.b));
